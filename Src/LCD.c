...
void LCD_DisplayNum(	POINT Xpoint, POINT Ypoint, float Nummber2,
						sFONT* Font,COLOR Color_Background, COLOR Color_Foreground ){
    int32_t Nummber = Nummber2;
    Nummber2 -= Nummber;
    Nummber2 *= 100;
    Nummber2 = (int) Nummber2;
	...
	for (int i = 0; i < 2; i++) {
            Num_Array[Num_Bit] = (int) Nummber2 % 10 + '0';
            Num_Bit++;
            Nummber2 /= 10;
        }
...
void LCD_Show(float *temp, float *press, float *hum)
{
...
//		LCD_DrawCircle(sLCD_DIS.LCD_Dis_Column - 15, 110, 10, BRRED, DRAW_FULL, DOT_PIXEL_DFT);
		...
		LCD_DisplayString(8,20, "Temp:", &Font12,LCD_BACKGROUND,RED);
		LCD_DisplayString(8,33, "Press:", &Font12,LCD_BACKGROUND,DGREEN);
		LCD_DisplayString(8,46, "Hum:", &Font12,LCD_BACKGROUND,BLUE);

		LCD_DisplayNum(52,20, *temp, &Font12,LCD_BACKGROUND,RED);
        LCD_DisplayNum(52,33, *press,&Font12,LCD_BACKGROUND,DGREEN);
        LCD_DisplayNum(52,46, *hum,&Font12,LCD_BACKGROUND,BLUE);

        LCD_DisplayString(90,20, "C", &Font12,LCD_BACKGROUND,RED);
        LCD_DisplayString(105,33, "hPa", &Font12,LCD_BACKGROUND,DGREEN);
        LCD_DisplayString(90,46, "%", &Font12,LCD_BACKGROUND,BLUE);
